...
export default function OrderDetails({ route } : Props) {
    ...
    const handleOnConfirmDelivery = () => {
        ...
        .then(() => {
            Alert.alert(`Pedido ${order.id} confirmado com suceso`);
            navigation.navigate('Orders');
        })
        .catch(() => {
    ...
    const handleStartNavigation = () =>{
        Linking.openURL(`https://www.google.com/maps/dir/?api=1&travelmode=driving&dir_action=navigate&destination=${order.lat},${order.lng}`);
    }
    /**/
    return (
        <>
